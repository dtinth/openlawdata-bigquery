...
4. State tracking via state.csv
...
- Scheduled daily at 17:00 UTC + manual trigger
- Uses Workload Identity Federation for GCP auth (no secrets)
- Auto-commits state.csv changes back to repo
